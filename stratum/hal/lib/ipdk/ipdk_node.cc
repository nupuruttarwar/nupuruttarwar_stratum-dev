...
IpdkNode::IpdkNode(TdiTableManager* tdi_table_manager,
...
IpdkNode::~IpdkNode() = default;

// Factory function for creating the instance of the class.
std::unique_ptr<IpdkNode> IpdkNode::CreateInstance(
    ...
    TdiSdeInterface* tdi_sde_interface, int device_id,
    bool initialized, uint64 node_id) {
  return absl::WrapUnique(new IpdkNode(
...
::util::Status IpdkNode::PushChassisConfig(const ChassisConfig& config,
                                           uint64 node_id) {
...
::util::Status IpdkNode::VerifyChassisConfig(const ChassisConfig& config,
                                             uint64 node_id) {
...
::util::Status IpdkNode::PushForwardingPipelineConfig(
...
::util::Status IpdkNode::SaveForwardingPipelineConfig(
    const ::p4::v1::ForwardingPipelineConfig& config) {
  absl::WriterMutexLock l(&lock_);
  if (!initialized_) {
...
::util::Status IpdkNode::CommitForwardingPipelineConfig() {
  absl::WriterMutexLock l(&lock_);
  if (!initialized_) {
    return MAKE_ERROR(ERR_NOT_INITIALIZED) << "Not initialized!";
  }
...
::util::Status IpdkNode::VerifyForwardingPipelineConfig(
...
::util::Status IpdkNode::Freeze() { return ::util::OkStatus(); }

::util::Status IpdkNode::Unfreeze() { return ::util::OkStatus(); }

::util::Status IpdkNode::WriteForwardingEntries(
    const ::p4::v1::WriteRequest& req, std::vector<::util::Status>* results) {
  absl::WriterMutexLock l(&lock_);
  CHECK_RETURN_IF_FALSE(req.device_id() == node_id_)
      << "Request device id must be same as id of this IpdkNode.";
...
::util::Status IpdkNode::ReadForwardingEntries(
...
::util::Status IpdkNode::RegisterStreamMessageResponseWriter(
...
::util::Status IpdkNode::UnregisterStreamMessageResponseWriter() {
  absl::WriterMutexLock l(&lock_);
  if (!initialized_) {
    return MAKE_ERROR(ERR_NOT_INITIALIZED) << "Not initialized!";
  }
...
::util::Status IpdkNode::HandleStreamMessageRequest(
...
::util::Status IpdkNode::WriteExternEntry(
...
::util::Status IpdkNode::ReadExternEntry(
    std::shared_ptr<TdiSdeInterface::SessionInterface> session,
