...
#ifndef STRATUM_HAL_LIB_IPDK_IPDK_NODE_MOCK_H_
#define STRATUM_HAL_LIB_IPDK_IPDK_NODE_MOCK_H_
...
class IpdkNodeMock : public IpdkNode {
 public:
...
#endif  // STRATUM_HAL_LIB_IPDK_IPDK_NODE_MOCK_H_
