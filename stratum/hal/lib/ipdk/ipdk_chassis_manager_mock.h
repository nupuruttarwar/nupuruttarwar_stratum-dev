...
#ifndef STRATUM_HAL_LIB_IPDK_IPDK_CHASSIS_MANAGER_MOCK_H_
#define STRATUM_HAL_LIB_IPDK_IPDK_CHASSIS_MANAGER_MOCK_H_
...
class IpdkChassisManagerMock : public IpdkChassisManager {
 public:
...
#endif  // STRATUM_HAL_LIB_IPDK_IPDK_CHASSIS_MANAGER_MOCK_H_
