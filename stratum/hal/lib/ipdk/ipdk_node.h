...
#ifndef STRATUM_HAL_LIB_IPDK_IPDK_NODE_H_
#define STRATUM_HAL_LIB_IPDK_IPDK_NODE_H_
...
// The IpdkNode class encapsulates all per P4-native node/chip/ASIC
...
class IpdkNode {
 public:
  ...
  static std::unique_ptr<IpdkNode> CreateInstance(
  ...
  // IpdkNode is neither copyable nor movable.
  IpdkNode(const IpdkNode&) = delete;
  IpdkNode& operator=(const IpdkNode&) = delete;
  IpdkNode(IpdkNode&&) = delete;
  IpdkNode& operator=(IpdkNode&&) = delete;
 ...
 private:
  ...
  // class.
  IpdkNode(TdiTableManager* tdi_table_manager,
           TdiActionProfileManager* tdi_action_profile_manager,
           TdiPacketioManager* tdi_packetio_manager,
           TdiPreManager* tdi_pre_manager,
           TdiCounterManager* tdi_counter_manager,
...
#endif  // STRATUM_HAL_LIB_IPDK_IPDK_NODE_H_
